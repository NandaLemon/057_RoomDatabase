...
import com.example.data_siswa.repository.RepositoriSiswa
import com.example.roomsiswa.ui.model.DetailSiswa
import com.example.roomsiswa.ui.model.UIStateSiswa
import com.example.roomsiswa.ui.model.toSiswa
import com.example.roomsiswa.ui.model.toUiStateSiswa
...
class EditViewModel(
    ...
    suspend fun updateSiswa() {
        if (validasiInput(siswaUiState.detailSiswa)) {
            repositoriSiswa.update(siswaUiState.detailSiswa.toSiswa())
        }
        else {
